...
function LocalMovieCard({ movie, index = 0 }) {
  return (
    ...
    >
      <Link to={ROUTES.LOCAL_MOVIE_DETAIL(movie.id)} className="group block overflow-hidden rounded-2xl bg-slate-900/40 ring-1 ring-white/5 transition-all duration-500 hover:ring-amber-500/40 hover:shadow-2xl hover:shadow-amber-500/10 hover:-translate-y-1">
