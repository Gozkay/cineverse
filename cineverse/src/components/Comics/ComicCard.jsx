...
function ComicCard({ comic, index = 0 }) {
  ...
  return (
    <TiltCard
      ...
      className="group relative overflow-hidden rounded-2xl bg-slate-900/40 ring-1 ring-white/5 transition-all duration-500 hover:ring-emerald-500/40 hover:shadow-2xl hover:shadow-emerald-500/10"
    >
