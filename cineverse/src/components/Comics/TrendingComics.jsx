      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-12 flex items-center justify-between">
            <div>
              <p className="font-semibold uppercase tracking-wider text-sm bg-gradient-to-r from-emerald-400 to-teal-400 text-transparent bg-clip-text">Popular Now</p>
              <h2 className="text-4xl sm:text-5xl font-black text-white">Trending Comics</h2>
            </div>
          </div>
        ...
        <div className="mb-12 flex items-end justify-between">
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-black mt-1">
              ...
              <span className="text-gradient-emerald">Comics</span>
            </h2>
          </div>
          <Link to={ROUTES.COMICS} className="group rounded-xl border border-white/10 bg-white/5 px-5 py-2.5 text-sm font-medium text-gray-300 transition-all hover:bg-white/10 hover:text-white hover:border-white/20 backdrop-blur-sm">
            View All
