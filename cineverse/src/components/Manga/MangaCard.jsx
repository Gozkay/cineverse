...
function MangaCard({ manga, index = 0 }) {
  ...
  return (
    <TiltCard
      ...
      className="group relative overflow-hidden rounded-2xl bg-slate-900/40 ring-1 ring-white/5 transition-all duration-500 hover:ring-pink-500/40 hover:shadow-2xl hover:shadow-pink-500/10"
    >
