...
| 06 | [06-PAGES.md](./06-PAGES.md) | All page components — Home, Movies, MovieDetails, Books, BookDetails, Manga, MangaDetails, Comics, ComicDetails, Cart, Checkout, Wishlist, Search, Profile, Login, Register, NotFound, Info pages (Contact/FAQ/Privacy/Terms), Dashboard pages (Admin, Manager, Staff) |
